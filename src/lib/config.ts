...
export interface ChartConfig {
	/**
	 * @deprecated The value axis no longer overlays the plot and is transparent.
	 * This option is retained temporarily for backwards compatibility.
	 */
	...
	/**
	 * @deprecated Clip-path IDs are generated internally with React `useId`.
	 * This option is retained temporarily for backwards compatibility.
	 */
